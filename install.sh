...
display_welcome() {
  ...
  echo -e ""
  echo -e "JANGAN LUPA SUBSCRIBE @Yucaiove"
  echo -e ""
  echo -e "TQ TO :"
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY XYZEN OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  ...
  if [ "$USER_TOKEN" = "iniwannbroku" ]; then
    ...
    echo -e "${GREEN} Silahkan Tanyakan Kepada XyzenOFFICIAL Jika Token Salah.${NC}"
    exit 1
  fi
  clear
}
